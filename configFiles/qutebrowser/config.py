...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/kur/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/kur/.local/share/qutebrowser/userscripts/*')

# Enable plugins in Web pages.
# Type: Bool
config.set('content.plugins', False, '*://help/*')

# Enable private browsing for not storing any data on the browser
# Type: Bool
